...
<div id="main" class="content djax-updatable">
	<?php lens::display_filter_box( 'lens_gallery_categories' ); ?>
	<div class="mosaic">
		<?php
		...
		<div class="mosaic__item  mosaic__item--page-title-mobile <?php echo $has_post_thumbnail ? "" : "js--is-loaded "; echo lens::get_terms_as_string('lens_gallery_categories', 'slug'); ?> ">
		...
		if ( $query->have_posts() ) :
			...
			while ( $query->have_posts() ) : $query->the_post();
				...
				if ($idx == 3) : ?>
					<div class="mosaic__item  mosaic__item--page-title <?php echo $has_post_thumbnail ? "" : "js--is-loaded "; echo lens::get_terms_as_string('lens_gallery_categories', 'slug'); ?>">
						<div class="image__item-link">
							<div class="image__item-wrapper">
								<?php if ($has_post_thumbnail) : ?>
									<img
