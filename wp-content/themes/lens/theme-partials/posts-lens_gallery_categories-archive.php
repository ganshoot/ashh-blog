...
<div id="main" class="content djax-updatable">
    ...
    <div class="mosaic">
        <div class="mosaic__item  mosaic__item--page-title-mobile js--is-loaded <?php echo lens::get_terms_as_string('lens_gallery_categories', 'slug'); ?>">
        ...
        while ( have_posts() ) : the_post();
            ...
            if ($idx == 3) : ?>
            <div class="mosaic__item mosaic__item--page-title js--is-loaded  <?php echo lens::get_terms_as_string('lens_gallery_categories', 'slug'); ?>">
                <div class="image__item-link">
                    <div class="image__item-wrapper">                      
                    </div>
                    <div class="image__item-meta">
