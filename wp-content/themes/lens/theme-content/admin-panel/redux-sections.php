	...
	$sections[] = array(
		...
		'fields' => array(
            ...
            array(
                ...
                'sub_desc' => __('Change the left sidebar contrast: black text, white background.', wpgrade::textdomain()),
                'std' => '0',
                'switch' => true,
            ),            
			array(
...
//                'validate_callback' => 'write_custom_css',
	...
	$sections[] = array(
      ...
      array(
        ...
        'sub_desc' => __('Display a Filter button on Portfolio and Gallery Archive Page', wpgrade::textdomain()),
        'std' => '1',
        'switch' => true,
      ),
			array(
