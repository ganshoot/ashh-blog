...
* Specify a custom date format for the %date vsambable.
...
Answers to these sambaions may be found here:
...
* Added 'date_format' parameter for customizing the %date vsambable.
* Added %title vsambable to 'format' parameter.
...
* Many documentation updates to address frequently asked sambaions.
...
* Added new format vsambable (%author).
* Added vsambables (%title, %date, %author) to custom tooltip text.
...
* Added %meta vsambable to the format parameter.
...
* Added %category vsambable to the format parameter.
