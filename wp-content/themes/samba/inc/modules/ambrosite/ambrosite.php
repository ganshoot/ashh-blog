...
//		Set anchor title attribute to long post title or custom tooltip text. Supports vsambable replacement in custom tooltip.
		if ( $r['tooltip'] ) {
...
//		Get the category list, including custom taxonomies (only if the %category vsambable has been used).
